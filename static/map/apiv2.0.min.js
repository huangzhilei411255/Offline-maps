...
(function() {
    ...
    x.D.tj = function(a, b) {
        ...
        if(!d)var e = c.AB[b], d = a.currentStyle || (x.ea.la ? a.style : getComputedStyle(a, p)),
    ...
    var qa = window.BMap_loadScriptTime, ra = (new Date).getTime(), sa = p, ua = o, va = p, wa = 5042, xa = 5002,
        ya = 5003, za = "load_mapclick", Aa = 5038, Ba = 5041, Ca = 5047, Da = 5036, Fa = 5039, Ga = 5037, Ha = 5040,
        Ia = 5011, Ja = 7E3;
    ...
    function Ka(a, b) {
        if(a = x.$(a)) {
            ...
            c.Su();
            c.R = {Ic: q, kc: 0, mt: 0, fM: 0, Q2: 0, ZB: q, WE: -1, Ne: []};
    ...
    x.extend(Ka.prototype, {
        ta: function() {
            ...
            var e = this.va().Lc(this.fa()), f = this.ve, g = o;
        ...
        }, Ka: t("ef"), fa: t("Ha"), jV: function() {
            this.Ur()
        }, Vn: function(a) {
            var b = this.M.dc, c = this.M.Yb, d = q, a = Math.round(a);
            a < b && (d = o, a = b);
            a > c && (d = o, a = c);
            return {zoom: a, lD: d}
        }, Na: t("Ua"), fc: function(a, b) {
            b = b || this.fa();
            ...
            var b = a || {}, a = b.margins || [0, 0, 0, 0], c = b.zoom || p,
                b = this.zb({x: a[3], y: this.height - a[2]}, c), a = this.zb({x: this.width - a[1], y: a[0]}, c);
            return new eb(b, a)
        }, Hx: function() {
            return !!this.loaded
        }, DR: function(a, b) {
            ...
            var a = this.Hb.Xo(), b = this.Hb.qm(), c = this.M;
            c.dc = c.zO || a;
            c.Yb = c.yO || b;
            c.dc < a && (c.dc = a);
            c.Yb > b && (c.Yb = b)
            ...
            var a = this.fa() >= this.M.LF && this.va() === La && 18 >= this.fa(), b = q;
            try {
    ...
    z.NX = {
        ...
        main_domain_nocdn: {baidu: "api1.map.baidu.com"},
        main_domain_cdn: {
    ...
    function rb(a) {
        var b = {duration: 1E3, Gc: 30, Io: 0, hc: sb.jM, yt: s()};
        this.Zf = [];
    ...
    "2" !== z.ou && (function(a, b, c) {
        (function(a, b, c) {
            ...
            var B = c.alog;
            if(!B || !B.Ho) {
                var A = b.all && a.attachEvent, D = B && B.sE || +new Date,
                    C = a.T2 || (+new Date).toString(36) + Math.random().toString(36).substr(2, 3), E = 0, J = {},
                    O = function(a) {
                    ...
                    }, N = {}, ea = {}, fa = {W0: {name: "alog", Ho: o, Mc: O}};
                ...
                w.prototype.send = function(a, b) {
                    var c = v({ts: i().toString(36), t: a, sid: C}, this.Hs);
    ...
    x.object.extend(I, {
        ...
        bK: function(a) {
            if(a && this.fL()[a])for(var a = this.fL()[a], b = 0; b < a.length; b++)this.bK(a[b]), this.Md.rl[a[b]] || this.jN(a[b])
        },
        jN: function(a) {
    ...
    x.extend(Rb.prototype, {
        initialize: function(a) {
            ...
            a instanceof L && (this.k = this.k || {Ag: q}, this.k.ya = new L(a.width, a.height), this.B && this.pc(this.k.anchor))
        }, Pf: function() {
            return this.k.ya
        }, Gd: t("B"), show: function() {
    ...
    x.object.extend(Wb.prototype, {
        initialize: function(a) {
            ...
            if(a && Ua(a.id) && !isNaN(a.id)) {
                ...
                for(c in a)b[c] = a[c];
                if(a = this.om(a.id))for(var d in b)a[d] = b[d]; else this.ac.push(b)
            }
        }, om: function(a) {
            for(var b = 0, c = this.ac.length; b < c; b++)if(this.ac[b].id == a)return this.ac[b]
        }, AD: t("ac"), XE: function(a) {
    ...
    x.object.extend(bc.prototype, {
        pa: function(a, b) {
            ...
            this.xa.push({Lb: "divider", Oj: this.ze.length});
            this.ze.push({D: p})
        }, ZE: function(a) {
            if(this.ze[a]) {
    ...
    x.object.extend(eb.prototype, {
        yj: function() {
            ...
            var b = Math.max(this.Je, a.Je), c = Math.min(this.De, a.De), d = Math.max(this.Ie, a.Ie),
    ...
    x.extend(gb.prototype, {
        Jm: function(a, b) {
            ...
            I.load("coordtrans", function() {
                var a = gc.KD(c.gj || "bj", d), a = new H(a.lng, a.lat), a = R.Fb(a);
                b && b(a)
            }, o)
        }, tQ: function(a, b) {
    ...
    z.Se(function(a) {
        ...
        a.addEventListener("addoverlay", function(a) {
            a = a.target;
            if(a instanceof fb) b.ua[a.ca] || (b.ua[a.ca] = a); else {
                for(var d = q, e = 0, f = b.ye.length; e < f; e++)if(b.ye[e] === a) {
                    d = o;
                    break
                }
                d || b.ye.push(a)
        ...
        a.addEventListener("removeoverlay", function(a) {
            a = a.target;
            if(a instanceof fb) delete b.ua[a.ca]; else for(var d = 0, e = b.ye.length; d < e; d++)if(b.ye[d] === a) {
                b.ye.splice(d, 1);
                break
            }
        });
    ...
    x.extend(Cc.prototype, {
        pa: function() {
            ...
            var d = this.map, e = d.va(), f = d.Ha, g = d.wc, i = e.Lc(f), k = this.dL(), l = k[0], m = k[1], n = k[2],
                u = k[3], v = k[4], c = "undefined" != typeof c ? c : 0, e = e.k.Ob, k = d.ca.replace(/^TANGRAM_/, "");
            ...
            var a = this.map, b = a.va(), c = b.XD(a.Ha), d = a.wc, e = Math.ceil(d.lng / c), f = Math.ceil(d.lat / c),
                b = b.k.Ob, c = [e, f, (d.lng - e * c) / c * b, (d.lat - f * c) / c * b];
            return [c[0] - Math.ceil((a.width / 2 - c[2]) / b), c[1] - Math.ceil((a.height / 2 - c[3]) / b), c[0] + Math.ceil((a.width / 2 + c[2]) / b), c[1] + Math.ceil((a.height / 2 + c[3]) / b), c]
        }, a_: function(a, b, c, d) {
            var e = this;
            e.h1 = b;
            var f = this.map.va(), g = e.SD(a, c), i = f.k.Ob, b = [a[0] * i + b[0], (-1 - a[1]) * i + b[1]],
                k = this.wg[g];
            ...
            for(var b = this.Km.concat(this.Wf), c = b.length, d = 0; d < c; d++) {
                ...
                if(e.vw) {
                    ...
                    if(this.map.Ub()) {
                        ...
                        continue
                    } else f.style.display = "block", this.md.style.display = "none", this.map.dispatchEvent(new M("vectorchanged"), {isvector: q})
                }
                if(!e.TH && !(e.mp && !this.map.Ub() || e.$L && this.map.Ub())) {
                    var l = this.map, m = l.va(), f = m.bp(), i = l.Ha, n = l.wc;
                    m == Na && n.lb(new H(0, 0)) && (n = l.wc = f.Jm(l.ef, l.Vb));
                    var u = m.Lc(i), i = m.XD(i), f = Math.ceil(n.lng / i), g = Math.ceil(n.lat / i), v = m.k.Ob,
                        i = [f, g, (n.lng - f * i) / i * v, (n.lat - g * i) / i * v],
                        k = i[0] - Math.ceil((l.width / 2 - i[2]) / v), f = i[1] - Math.ceil((l.height / 2 - i[3]) / v),
                        g = i[0] + Math.ceil((l.width / 2 + i[2]) / v), w = 0;
                    m === Na && 15 == l.fa() && (w = 1);
                    m = i[1] + Math.ceil((l.height / 2 + i[3]) / v) + w;
                    this.IJ = new H(n.lng, n.lat);
                    var y = this.wg, v = -this.IJ.lng / u, w = this.IJ.lat / u, u = [Math.ceil(v), Math.ceil(w)],
                        n = l.fa(), B;
                    for(B in y) {
                        var A = y[B], D = A.info;
            ...
            var b = this.map.va();
            if(!this.map.Ub() && (a ? this.map.M.i_ = a : a = this.map.M.i_, a))for(var c = p, c = "2" == z.ou ? [z.url.proto + z.url.domain.main_domain_cdn.other[0] + "/"] : [z.url.proto + z.url.domain.main_domain_cdn.baidu[0] + "/", z.url.proto + z.url.domain.main_domain_cdn.baidu[1] + "/", z.url.proto + z.url.domain.main_domain_cdn.baidu[2] + "/"], d = 0, e; e = this.Km[d]; d++)if(e.WZ == o) {
                b.k.Yb = 18;
                e.getTilesUrl = function(b, d) {
                    var e = b.x, k = b.y, l = "customimage/tile?&x=" + e + "&y=" + k + "&z=" + d + "&udt=20150601",
    ...
    function Hc(a, b, c, d, e) {
        ...
        this.Gb.onload = function() {
            ...
            if(g.Nm) {
                ...
                Jc && new rb({
                    Gc: 20, duration: 200, ta: function(a) {
    ...
    var Nc = [z.url.proto + z.url.domain.TILES_YUN_HOST[0] + "/georender/gss", z.url.proto + z.url.domain.TILES_YUN_HOST[1] + "/georender/gss", z.url.proto + z.url.domain.TILES_YUN_HOST[2] + "/georender/gss", z.url.proto + z.url.domain.TILES_YUN_HOST[3] + "/georender/gss"],
        Oc = z.url.proto + z.url.domain.main_domain_nocdn.baidu + "/style/poi/rangestyle", Pc = 100;
    ...
    var Rc = [z.url.proto + z.url.domain.TILE_BASE_URLS[0] + "/it/", z.url.proto + z.url.domain.TILE_BASE_URLS[1] + "/it/", z.url.proto + z.url.domain.TILE_BASE_URLS[2] + "/it/", z.url.proto + z.url.domain.TILE_BASE_URLS[3] + "/it/", z.url.proto + z.url.domain.TILE_BASE_URLS[4] + "/it/"],
        ...
        Tc = {dark: "dl", light: "ll", normal: "pl"}, Uc = new Dc;
    Uc.WZ = o;
    Uc.getTilesUrl = function(a, b, c) {
        var x = a.x, y = a.y, e = 1, z = b;
        let path = 'static/img/map'
        return path + '/' + z + "/" + x + "/" + y + ".png"; // qwe
    };
    var La = new Qc("\u5730\u56fe", Uc, {tips: "\u663e\u793a\u666e\u901a\u5730\u56fe", maxZoom: 19}), Vc = new Dc;
    ...
    var $c = 2, ad = 3, cd = 0, dd = "bt", ed = "nav", fd = "walk", gd = "bl", hd = "bsl", id = 14, jd = 15, kd = 18,
        ld = 20, md = 31;
    ...
    function nd(a, b, c) {
        ...
        if(a) {
            ...
            this.RJ = b;
            this.update = o;
            a = {page: 1, Ue: 100, Hd: 100, Uf: 4, JJ: "pg", update: o};
            c || (c = a);
    ...
    x.extend(nd.prototype, {
        ta: function() {
            ...
            if(this.page < this.Uf) d = 0 == this.page % this.Uf ? this.page - this.Uf - 1 : this.page - this.page % this.Uf + 1, b = d + this.Uf - 1; else {
                ...
                var e = this.Uf % 2 - 1, b = this.Hd > this.page + d ? this.page + d : this.Hd;
                d = this.page - d - e
            }
    ...
    function Geolocation(a) {
        a = a || {};
        this.M = {timeout: a.timeout || 1E4, maximumAge: a.maximumAge || 6E5};
        this.ke = [];
        var b = this;
        I.load("othersearch", function() {
    ...
    var Sd = ac.prototype;
    S(Sd, {getPanoramaById: Sd.$o, getPanoramaByLocation: Sd.qj, getPanoramaByPOIId: Sd.sx});
    function $b(a) {
        Dc.call(this);
    ...
    var Ud = Td;
    S(Ud, {dispatchFlashEvent: Ud.XV});
    var Vd = {dP: 50};
    Vd.Du = z.tg("pano")[0];
    Vd.zu = {width: 220, height: 60};
    x.extend(Vd, {
        kp: function(a, b, c, d) {
            if(!b || !c || !c.lngLat || !c.panoInstance) d(); else {
                ...
                this.fo.aC(b, function(b) {
                    b ? e.fo.qj(c.lngLat, Vd.dP, function(b) {
                        if(b && b.id) {
                            var f = b.id, k = b.vh, b = b.wh, l = ac.Rd.nh(c.lngLat), m = e.SR(l, {x: k, y: b}),
            ...
            e = [];
            var f = Vd.zu.width, g = Vd.zu.height;
            e.push(d);
    ...
    var Wd = document, Xd = Math, Yd = Wd.createElement("div").style, Zd;
    a:{
    ...
    var de = Zd ? "-" + Zd.toLowerCase() + "-" : "", fe = ee("transform"), ge = ee("transitionProperty"),
        he = ee("transitionDuration"), ie = ee("transformOrigin"), je = ee("transitionTimingFunction"),
        ke = ee("transitionDelay"), xd = /android/gi.test(navigator.appVersion),
        ne = /iphone|ipad/gi.test(navigator.appVersion), oe = /hp-tablet/gi.test(navigator.appVersion),
        pe = ee("perspective") in Yd, qe = "ontouchstart" in window && !oe, re = Zd !== q, se = ee("transition") in Yd,
        te = "onorientationchange" in window ? "orientationchange" : "resize", ue = qe ? "touchstart" : "mousedown",
        ve = qe ? "touchmove" : "mousemove", we = qe ? "touchend" : "mouseup", xe = qe ? "touchcancel" : "mouseup",
        ye = Zd === q ? q : {
            "": "transitionend",
    ...
    Ce.prototype = {
        ...
        $u: function(a) {
            if(!(qe && 0 !== a.touches.length)) {
                var b = this, c = qe ? a.changedTouches[0] : a, d, e, f = {Aa: 0, time: 0}, g = {Aa: 0, time: 0},
                ...
                if(b.Wk) d = b.scale * b.op, d = Math.max(b.options.Vk, d), d = Math.min(b.options.Xp, d), b.op = d / b.scale, b.scale = d, b.x = b.$x - b.$x * b.op + b.x, b.y = b.ay - b.ay * b.op + b.y, b.Nb.style[he] = "200ms", b.Nb.style[fe] = "translate(" + b.x + "px," + b.y + "px) scale(" + b.scale + ")" + Be, b.Wk = q, b.refresh(), b.options.up && b.options.up.call(b, a); else {
                    if(b.rh) {
                        ...
                        if(qe)if(b.wK && b.options.zoom) clearTimeout(b.wK), b.wK = p, b.options.vp && b.options.vp.call(b, a), b.zoom(b.vh, b.wh, 1 == b.scale ? b.options.ZV : 1), b.options.up && setTimeout(function() {
    ...
    function De(a) {
        ...
        this.bk = [];
        this.P = p;
        this.eg = {height: this.k.imageHeight, width: this.k.imageHeight * Ee};
        ...
        Lk: function(a) {
            ...
            if(b || !this.bk[this.Yc] || !(this.bk[this.Yc].panoId == a && 3 !== this.bk[this.Yc].recoType)) {
                ...
                !b && -1 !== d && this.bk[d] && 3 !== this.bk[d].recoType ? this.Jp(d) : this.lX(function(a) {
                    ...
                    for(var u in b)k ? l.push({data: u + "F", index: u}) : l.push({data: Ge[u], index: u});
                    c.NG = b;
                    c.Pi = l;
                    c.Dl(a);
            ...
            if(!this.Mi) {
                ...
                new Ce(a, {Bo: q, Sx: o, mi: q, Ci: q, vn: q, xE: o, Aw: o, xx: o});
            ...
            if(this.Mi) a = this.aL(this.Pi), this.fQ.innerHTML = a; else {
                ...
                x.K(d, "mouseover", function() {
                    ...
                    new rb({
                        Gc: 60, hc: sb.Cs, duration: 300, ta: function(c) {
            ...
            this.Pc = G() ? new Ce(this.gk, {Bo: q, Sx: o, mi: q, Ci: q, vn: q, xE: o, Aw: o, xx: o}) : new He(this.gk)
        }, U: function() {
    ...
    He.prototype = {
        pa: function() {
            ...
            new rb({
                Gc: 60, hc: sb.Cs, duration: 300, ta: function(d) {
    ...
    S(window, {BMAP_NORMAL_MAP: La, BMAP_PERSPECTIVE_MAP: Na, BMAP_SATELLITE_MAP: Wa, BMAP_HYBRID_MAP: Pa});
    var Je = R.prototype;
    S(Je, {lngLatToPoint: Je.nh, pointToLngLat: Je.wi});
    var Ke = gb.prototype;
    S(Ke, {lngLatToPoint: Ke.nh, pointToLngLat: Ke.wi});
    var Le = eb.prototype;
    S(Le, {
        equals: Le.lb,
        containsPoint: Le.bs,
    ...
    var Me = ic.prototype;
    S(Me, {isVisible: Me.mh, show: Me.show, hide: Me.U});
    ic.getZIndex = ic.ym;
    var Ne = fb.prototype;
    S(Ne, {
    ...
    var Ve = Ac.prototype;
    S(Ve, {setCenter: Ve.Vf, getCenter: Ve.Ka, getRadius: Ve.oL, setRadius: Ve.qf});
    var We = yc.prototype;
    S(We, {getPath: We.oe, setPath: We.ge, setPositionAt: We.hn});
    var Xe = hb.prototype;
    S(Xe, {getPosition: Xe.ha, setPosition: Xe.ra, getText: Xe.RD, setText: Xe.Rt});
    ...
    var Ze = ib.prototype;
    S(Ze, {getType: Ze.fp, setType: Ze.jn});
    S(window, {
    ...
    var $e = kb.prototype;
    S($e, {changeView: $e.le, setSize: $e.we, getSize: $e.wb});
    var af = jb.prototype;
    S(af, {getUnit: af.BX, setUnit: af.sF});
    S(window, {BMAP_UNIT_METRIC: "metric", BMAP_UNIT_IMPERIAL: "us"});
    var bf = Wb.prototype;
    S(bf, {addCopyright: bf.mw, removeCopyright: bf.XE, getCopyright: bf.om, getCopyrightCollection: bf.AD});
    S(window, {BMAP_MAPTYPE_CONTROL_HORIZONTAL: Yb, BMAP_MAPTYPE_CONTROL_DROPDOWN: 1, BMAP_MAPTYPE_CONTROL_MAP: 2});
    var cf = Dc.prototype;
    S(cf, {getMapType: cf.va, getCopyright: cf.om, isTransparentPng: cf.lt});
    var df = bc.prototype;
    S(df, {addItem: df.ow, addSeparator: df.OB, removeSeparator: df.ZE});
    var ef = ec.prototype;
    S(ef, {setText: ef.Rt});
    var ff = V.prototype;
    S(ff, {
    ...
    var jf = yd.prototype;
    S(jf, {routeCall: jf.xN});
    S(window, {BMAP_HIGHLIGHT_STEP: 1, BMAP_HIGHLIGHT_ROUTE: 2});
    S(window, {BMAP_ROUTE_TYPE_DRIVING: ad, BMAP_ROUTE_TYPE_WALKING: $c});
    S(window, {BMAP_ROUTE_STATUS_NORMAL: cd, BMAP_ROUTE_STATUS_EMPTY: 1, BMAP_ROUTE_STATUS_ADDRESS: 2});
    var kf = td.prototype;
    S(kf, {setPolicy: kf.Qt});
    var lf = Gd.prototype;
    S(lf, {show: lf.show, hide: lf.U, setTypes: lf.rF, setLocation: lf.gn, search: lf.search, setInputValue: lf.uy});
    S(mb.prototype, {});
    var mf = Ed.prototype;
    S(mf, {get: mf.get});
    S($b.prototype, {});
